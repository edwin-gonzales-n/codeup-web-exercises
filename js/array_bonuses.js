...
var arrayOfNumbers = ['10', '20', '30', '40', '50', '60', '70', '80'];
...
//
//     console.log(input.reduce(getSum));
//
//
// }
...
var Addiditon = (arrayOfNumbers.reduce(function(prev, cur) {return parseFloat(prev) + parseFloat(cur);}));
var average = Addiditon/arrayOfNumbers.length;
console.log(average);

// ##########################

var pies = ["apple", "cherry", "banana", "strawberry", "apple", "pineapple", "lime", "huckleberry"];
